...
reghdfe dgdp c.l(1/3).dgdp poor#c.(dT dT2 c.tem##c.tem dP dP2 c.pre##c.pre) dpop  [aweight=weight], absorb( i.gid_nmbr i.subc#c.year i.poor#i.year) cluster(country1)
estimates store r1
...
xtabond2 dgdp c.l(1/3).dgdp dT dT2 c.tem##c.tem dP dP2 c.pre##c.pre poor#c.(dT dT2 c.tem##c.tem dP dP2 c.pre##c.pre) dpop  i.subc#c.year i.poor#i.year [aweight=weight], iv(dT dT2 c.tem##c.tem dP dP2 c.pre##c.pre  poor#c.(dT dT2 c.tem##c.tem dP dP2 c.pre##c.pre)  i.subc#c.year  dpop i.poor#i.year) gmm(c.L(1/3).dgdp, l(4 6)  ) nolevel cluster(country1)  artests(3) or
estimates store r2
