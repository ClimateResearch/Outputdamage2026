...
xtabond2 dgdp c.l(1/3).dgdp dT dT2 c.tem##c.tem dP dP2 c.pre##c.pre  dpop i.year i.subc#c.year [aweight=weight], iv(dT dT2 dP dP2 c.pre##c.pre c.tem##c.tem  i.year i.subc#c.year dpop) gmm(c.L(1/3).dgdp, l(4 6) )  nolevel cluster(country1) or
estimates store r5
lincom c.tem+2*25*c.tem#c.tem
