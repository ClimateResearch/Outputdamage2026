...
reghdfe dgdp poor#c.(l(1/2).dgdp c.dT c.dT2 c.tem##c.tem c.l.tem c.l.tem#c.l.tem c.dP c.dP2 c.pre##c.pre c.l.pre c.l.pre##c.l.pre dpop)  [aweight=weight],absorb(i.gid_nmbr i.year) vce( cluster country1) res(res)
...
esttab r5_1 r5_2 using "02table\Table4.rtf", star(* .1 ** .05  *** .01) nogap nonumber replace se(%5.4f) r2 ar2 aic(%10.4f) bic(%10.4f)