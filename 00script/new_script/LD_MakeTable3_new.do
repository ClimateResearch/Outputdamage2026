...
reghdfe dgdp poor#c.(l.dgdp c.dT c.dT2 c.tem##c.tem c.dP c.dP2 c.pre##c.pre dpop) [aweight=weight],absorb(i.gid_nmbr i.countsub1#i.year) vce( cluster country1)
estimates store r1
...
estimates store r2
lincom 0.poor#c.tem+2*5*0.poor#c.tem#c.tem
