...
xtabond2 dgdp c.l(1/`lag').dgdp c.l(0/`lag').tem `T2var' c.l(0/`lag').pre `P2var'  poor#( c.l(0/`lag').tem `T2var' c.l(0/`lag').pre `P2var' ) c.dpop i.year i.subc#c.year [aweight=weight], iv(c.l(0/`lag').tem `T2var' c.l(0/`lag').pre `P2var'  poor#( c.l(0/`lag').tem `T2var' c.l(0/`lag').pre `P2var' ) c.dpop i.year i.subc#c.year) gmm(c.L(1/`lag').dgdp, l(`lmin' `lmax') ) nolevel cluster(country1)  artests(3) or
