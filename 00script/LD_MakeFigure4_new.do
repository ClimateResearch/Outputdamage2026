...
twoway ///
(line c2 c1 if c5 == 3, lcolor("252 141 98") lw(1.5pt))  ///
(rarea c3 c4 c1 if c5 == 5, fcolor( "60 180 160%30") lcolor(%0) ) ///
(line c2 c1  if c5 == 5,lcolor("60 180 160") lw(1.5pt) )  ///
 , ///
